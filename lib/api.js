...
export async function updateStudioProfile(name, address, widgetBgColor, widgetAccentColor, walkinCutPercent, personalCutPercent, aftercareInstructions, timezone, latitude, longitude, paymentRecordingRequirement, rescheduleWindowHours, widgetConsentTemplateId, sendReminder7d, sendReminder24h) {
  const headers = { ...(await authHeaders()), 'Content-Type': 'application/json' };
