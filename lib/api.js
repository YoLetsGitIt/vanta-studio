...
export async function updateStudioProfile(name, address, widgetBgColor, widgetAccentColor, walkinCutPercent, personalCutPercent, aftercareInstructions, timezone, latitude, longitude) {
  const headers = { ...(await authHeaders()), 'Content-Type': 'application/json' };
