...
export async function updateStudioProfile(name, address, widgetBgColor, widgetAccentColor, walkinCutPercent, personalCutPercent, aftercareInstructions, timezone) {
  const headers = { ...(await authHeaders()), 'Content-Type': 'application/json' };
