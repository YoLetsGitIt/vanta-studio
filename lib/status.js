...
export const STATUS_COLORS = {
  ...
  requires_confirmation:  { bg: 'rgba(111,163,232,0.12)', text: '#6fa3e8', border: 'rgba(111,163,232,0.25)' },
  ...
  deposit_expired:        { bg: 'rgba(232,111,111,0.1)', text: '#e86f6f', border: 'rgba(232,111,111,0.2)' },
};
...
export const APPROVAL_STATUS_COLORS = {
  ...
  removed:  { bg: 'var(--bg-chip)', text: 'var(--text-ghost)', border: 'var(--border)' },
};
