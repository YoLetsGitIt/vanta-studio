...
export async function updateStudioProfile(name, address, widgetBgColor, widgetAccentColor, walkinCutPercent, personalCutPercent, aftercareInstructions, timezone, latitude, longitude, paymentRecordingRequirement) {
  const headers = { ...(await authHeaders()), 'Content-Type': 'application/json' };
