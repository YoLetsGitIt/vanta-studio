...
const s = {
  ...
  artistGuideOverlay: { position: 'fixed', inset: 0, zIndex: 1000, display: 'grid', placeItems: 'center', padding: '1.25rem', background: 'rgba(0,0,0,0.78)', backdropFilter: 'blur(8px)' },
  artistGuideCard: { width: 'min(100%, 940px)', maxHeight: 'min(760px, calc(100vh - 2.5rem))', overflow: 'auto', position: 'relative', display: 'grid', gridTemplateColumns: 'minmax(0, 1.3fr) minmax(250px, 0.7fr)', gap: '2rem', padding: '2rem', borderRadius: 18, background: 'var(--bg-modal)', border: '1px solid var(--border)', boxShadow: 'var(--shadow-modal)' },
  ...
  mobilePhone: { width: 224, padding: '0.45rem', borderRadius: 28, background: '#090909', border: '4px solid #353535', boxShadow: '0 20px 48px rgba(0,0,0,0.3)' },
  phoneSpeaker: { width: 64, height: 5, margin: '0.15rem auto 0.45rem', borderRadius: 4, background: '#353944' },
  phoneScreen: { minHeight: 350, padding: '1.15rem', display: 'flex', flexDirection: 'column', borderRadius: 21, background: 'linear-gradient(150deg, #191919, #0a0a0a)' },
