...
const s = {
  ...
  studioName: { fontSize: '0.925rem', fontWeight: 700, color: '#ffffff' },
  studioAddr: { fontSize: '0.78rem', color: 'rgba(255,255,255,0.4)' },
  cardMeta: { fontSize: '0.72rem', color: 'rgba(255,255,255,0.25)', marginTop: 2 },
  statusBadge: {
    fontSize: '0.7rem',
    fontWeight: 600,
    padding: '0.15rem 0.5rem',
